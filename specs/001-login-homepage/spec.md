...
- **FR-008**: 系統必須能夠將相同 email 的不同社群帳號連結到同一使用者。每個 email 在系統中必須是全域唯一的，當使用者用新的社群帳號（但相同 email）登入時，自動連結到現有使用者而非建立新帳號
...
- **FR-014**: 系統必須提供帳號刪除功能，當使用者刪除帳號時，永久移除所有個人資料（使用者資訊、社群帳號連結、會話記錄），但保留匿名化的審計日誌以符合安全追蹤需求
